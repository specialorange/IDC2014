...
\section{\sloppy Educational and Computational Thinking Games}
\label{sec:ed_games}
...
Resnick et al. has proposed ``digital manipulatives'' as a continuation of this work where students are called to control through Logo programming other tangible artifacts like blocks, balls, beads, and badges \cite{liebschner1992child}.

Other researchers have also argued about the educational benefit of using computationally-enhanced construction kits where kids build 3D models and ``learn through tactile experiences'' \cite{eisenberg2002computationally}.
...
We analysed each game for the following common CT definitional paradigms: modeling, abstraction, algorithms, artistic creation, goal disection, risk/reward comparison, shared roles, patterns, simulation, and other unique yet clear CT characteristics.
We describe CT modeling in games as the creation of an operational abstraction that captures the properties of an object sufficient for reasoning or simulation; e.g. in Guess Who you have to model a person to identify, and understand the different physical characteristics of the person as well as the articles that each person may wear.
...
We ran an informal pilot of the game to elementary students in a local school. We followed Brandt's anecdote and interrogator method \cite{brandt1972studying} for data collection, to help protect the confidentiality of the students. 
...
As predicted in {\em \hyperref[sec:observations]{\nameref{sec:observations}}}, we expect that this would help the children approach the complex puzzles with a more nuanced understanding pieces.
...
% Regarding the children's process for searching, Michael noticed the students describing to each other the shapes they wanted for a particular position on the board. 
...
% Additionally, Chris and Panagiotis, supervising another group, were very effective in leading students to evaluate the different properties of a missing piece. 
Due to the success of the guiding questions mentioned in {\em \hyperref[sec:observations]{\nameref{sec:observations}}}, we will include activities that explicitly ask  those questions, so that students must engage more deeply with the game and its components.
...
\tiny
    \vspace*{-12cm}\hspace*{-1cm}\begin{tabular}{|p{1.3cm}||p{1cm}|p{2cm}|p{2cm}|p{1.6cm}|p{2cm}|p{1.3cm}|p{2cm}|p{1cm}|p{1.3cm}|p{2.7cm}|p{1cm}|}
    
    \hline

    Game & Modeling & Abstraction & Functions & Artistic Creation & Goal Disection & Risk/Reward == Comparison & Situational Turn Based Forecasting & Shared Roles & Patterns & Algortihms & Simulation \\ \hline \hline
    
    \multicolumn{12}{|l|}{Current Games}  \\ \hline \hline
    
    Pandemic & NO & NO & NO & NO & \cellcolor{blue!25} YES & YES & NO & \cellcolor{blue!25}YES & \cellcolor{blue!25}YES & NO & NO \\ \hline
    
    Settlers Of Catan & NO & NO & NO & NO & \cellcolor{blue!25}YES & NO & \cellcolor{blue!25}YES & NO & NO & NO & NO \\ \hline

    Robot Turtles & NO & NO & \cellcolor{blue!25}YES & NO & \cellcolor{blue!25}YES & NO & NO & NO & \cellcolor{blue!25}YES & \cellcolor{blue!25}YES & \cellcolor{blue!25}YES \\ \hline

    Mr. Jack & NO & NO & NO & NO & \cellcolor{blue!25}YES & NO & NO & NO & NO & NO & NO \\ \hline

    Ticket To Ride & NO & NO & NO & NO & \cellcolor{blue!25}YES & NO & \cellcolor{blue!25}YES & NO & \cellcolor{blue!25}YES & NO & NO \\ \hline

    Carcassonne & NO & NO & NO & NO & \cellcolor{blue!25}YES & NO                                                   & \cellcolor{blue!25}YES & NO & NO & NO & NO \\ \hline

    Guess Who & \cellcolor{blue!25}YES & NO & NO & \cellcolor{blue!25}YES & \cellcolor{blue!25}YES & NO & NO & NO & \cellcolor{blue!25}YES & \cellcolor{blue!25}YES & NO \\ \hline

    Chess & In formations & NO & \cellcolor{blue!25}YES & NO & MAYBE & NO & \cellcolor{blue!25}YES, but even strong computers fail at this & NO & NO & NO & NO \\ \hline

    Checkers & NO & NO & \cellcolor{blue!25}YES & NO & NO & YES & \cellcolor{blue!25}YES & NO & NO & NO & NO \\ \hline

    Blockus & NO & NO & NO & NO & \cellcolor{blue!25}YES & NO & \cellcolor{blue!25}YES, in end game & NO & \cellcolor{blue!25}YES & NO & NO \\ \hline

    Resistance & NO & NO & NO & NO & NO & NO & NO & NO & NO & NO & NO \\ \hline

    Acquire & NO & NO & NO & NO & \cellcolor{blue!25}YES & NO & NO & NO & NO & NO & NO \\ \hline

    Tic Tac Toe & NO & NO & NO & NO & NO & NO & \cellcolor{blue!25}YES & NO & \cellcolor{blue!25}YES & \cellcolor{blue!25}YES & NO \\ \hline

    Clue & NO & NO & \cellcolor{blue!25}YES - to minimize turns taken & NO & NO & YES & NO & NO & NO & \cellcolor{blue!25}YES & NO \\ \hline

    3-15 & NO & NO & NO & NO & \cellcolor{blue!25}YES & NO & NO & NO & NO & NO & NO \\ \hline

    Cranium & NO & NO & NO & \cellcolor{blue!25}YES & NO & NO & NO & \cellcolor{blue!25}YES & NO & NO & NO \\ \hline

    Battleship & NO & \cellcolor{blue!25}YES & \cellcolor{blue!25}YES & NO & NO & NO & \cellcolor{blue!25}YES & NO & \cellcolor{blue!25}YES & \cellcolor{blue!25}YES & NO \\ \hline

    Dominoes & NO & NO & \cellcolor{blue!25}YES & NO & NO & NO & \cellcolor{blue!25}YES & NO & NO & \cellcolor{blue!25}YES & NO \\ \hline

    Mad Lib & \cellcolor{blue!25}YES & NO & NO & \cellcolor{blue!25}YES & NO & NO & NO & NO & NO & NO & NO \\ \hline \hline

    \multicolumn{12}{|l|}{Proposed Games} \\ \hline \hline

    nMotion (Catapult) & \raggedright{Weapons, targets, ammunition, play field (with constraints)} & \raggedright{Methods vs models, Trial \& error to understand each model.\newline \newline The different stages (play|design|test) allow for stronger abstractions, especially across situations} & \raggedright{EASY: Aim, prime, fire, and move.\newline \newline DIFFICULT: switch people, defend, and how to define communication(parameters) to each other} & \raggedright{Less so, but maybe if they create their own weapon from methods/functions.\newline \newline Or are allowed to create a defense} & \raggedright{Starting with a goal, they identify the components that will help them achieve their goal.   Several layers of dissection will need to occur to be proficient} & \raggedright{Given a limited number of attempts} & \raggedright{A correct analysis of the situation, as well as appropriate selection and execution of methods enables role playing and challenges that should expand stronger methods, models, and artistic creation.} & \raggedright{Team based competition} & \raggedright{There are patterns in the trial and error in recognizing performance} & \raggedright{The students can create a set of nested steps to perform tasks.\newline \newline The effectiveness of another team member executing the task without any follow up communication (verbal or other) can be measured. The team's collective algorithms could be assessed on another team performing the task and the questions that arise out of their performance.} & \raggedright{The play phase of this game is simulation.} \\ \hline
    
    Hero Game & \cellcolor{blue!25}YES & \cellcolor{blue!25}YES & NO & \cellcolor{blue!25}YES & NO & \cellcolor{blue!25}YES & NO & NO & NO & NO & NO \\ \hline
    
    Sorting height of students & NO & NO & \cellcolor{blue!25}YES & NO & \cellcolor{blue!25}YES & NO & NO & NO & NO & \cellcolor{blue!25}YES & NO \\ \hline
    
    Collaborative matching & NO & NO & NO & NO & NO & NO & NO & NO & NO & NO & NO \\ \hline
    
    Mixing water Bottles (from Die Hard\cite{diehard2008thorp}) & \cellcolor{blue!25}YES & \cellcolor{blue!25}YES & \cellcolor{blue!25}YES & NO & \cellcolor{blue!25}YES & NO & NO & NO & \cellcolor{blue!25}YES & NO & NO \\ \hline
    
    Bi Directional Mad Libs & \cellcolor{blue!25}YES & \cellcolor{blue!25}YES & NO & \cellcolor{blue!25}YES & NO & NO & NO & NO & NO & NO & NO \\ \hline
    
    Rab-Bit Esc-Ape & \raggedright{The wooden bits and designated path structures} & ~ & ~ & \raggedright{Creating new path levels} & \raggedright{Path must be broken down into chunks and separate models constructed for each chunk} & \raggedright{Given a time restriction, strategies come into play} & ~ & \raggedright{Players can choose to work either in different parts of the board or the same one} & \raggedright{Bit combinations, by analyzing the path, the enemies, and magnet polarity & reusability of paths or components across game boards; extra points are awarded for using such blocks. Over time they get better at this `algorithmic' approach of reusing bits per case (e.g., round corners, U turns, etc.)} & ~ \\ \hline
